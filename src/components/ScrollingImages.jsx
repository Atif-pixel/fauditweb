...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.scale = this.screen.height / 4500;
    this.plane.scale.y = (this.viewport.height * (4900 * this.scale)) / this.screen.height;
    this.plane.scale.x = (this.viewport.width * (4500 * this.scale)) / this.screen.width;
...
class App {
  constructor(container, { items, bend, textColor = "#ffffff", borderRadius = 0, font = "bold 30px DM Sans" } = {}) {
    ...
    this.autoScrollSpeed = 0.07; // Speed of automatic scrolling
    this.createRenderer();
    this.createCamera();
    this.createScene();
    this.onResize();
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: '/assets/world.png', text: 'Default Image' },
  ...
  update() {
    // Automatically increment the scroll target
